...
const EventsPage = () => {
  ...
  const events = [
    {
      ...
      attendees: 45,
      maxAttendees: 60,
      description: 'Learn the fundamentals of Web3 development including smart contracts, DeFi protocols, and dApp creation.',
    ...
    },
    {
      ...
      attendees: 78,
      maxAttendees: 100,
      description: 'Intensive 2-day bootcamp covering modern AI techniques, neural networks, and practical ML applications.',
    ...
    },
    {
      ...
      attendees: 120,
      maxAttendees: 150,
      description: 'Present your startup ideas to industry experts, investors, and fellow entrepreneurs.',
    ...
    },
    {
      ...
      attendees: 200,
      maxAttendees: 300,
      description: 'Annual cybersecurity conference featuring industry leaders discussing latest threats and defense strategies.',
      image: 'https://images.pexels.com/photos/60504/security-protection-anti-virus-software-60504.jpeg?auto=compress&cs=tinysrgb&w=800',
      status: 'upcoming',
      tags: ['Cybersecurity', 'Privacy', 'Defense']
    }
  ];
  ...
  const categories = [
    ...
    { id: 'bootcamp', label: 'Bootcamps', count: events.filter(e => e.category === 'bootcamp').length },
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="scroll-animate opacity-0 translate-y-10">
            ...
            <p className="text-xl text-white/70 max-w-3xl mx-auto leading-relaxed">
              Join our exciting events, workshops, and conferences designed to expand your knowledge 
        ...
        <div className="max-w-7xl mx-auto text-center">
          <GlassCard className="p-16 scroll-animate opacity-0 translate-y-10" gradient hover3D>
            <h2 className="text-4xl font-bold text-white mb-6">
              Want to Host an <span className="bg-gradient-to-r from-electric-cyan to-neon-purple bg-clip-text text-transparent">Event?</span>
            </h2>
            <p className="text-xl text-white/70 max-w-2xl mx-auto mb-8 leading-relaxed">
              Share your knowledge and expertise with our community. We're always looking for passionate speakers and workshop leaders.
            </p>
