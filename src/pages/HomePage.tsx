...
const HomePage = () => {
  ...
  const stats = [
    ...
    { number: "10+", label: "Event yang di adakan tahun ini", icon: Calendar },
  ...
  const sliderImages = [
    ...
    "https://images8049-bebda4e38f71?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
    "https://images.unsplash.com/photo-1551434678-e076c223a692?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
  ];
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
              <button className="group relative px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-electric-cyan to-neon-purple rounded-full font-semibold text-white shadow-lg shadow-electric-cyan/25 hover:shadow-electric-cyan/40 transition-all duration-300 hover:scale-105">
          ...
          <div className="mt-16 text-center">
            <div className="scroll-animate opacity-0 translate-y-10">
              <GlassCard className="p-8 max-w-3xl mx-auto transform transition-all duration-500 hover:scale-105 hover:-translate-y-2">
                ...
                <button className="px-8 py-3 bg-gradient-to-r from-electric-cyan to-neon-purple rounded-full font-semibold text-white shadow-lg hover:shadow-electric-cyan/40 transition-all duration-300 hover:scale-105 transform hover:-translate-y-1">
